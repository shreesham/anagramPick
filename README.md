...
2. Clone this repository - `git clone https://github.com/shreesham/anagramPick`
...
### Setup
1. Ensure 3 devices are on a local network, or that the application server is accessible by 3 devices.
2. Start the Anagram Pick application
